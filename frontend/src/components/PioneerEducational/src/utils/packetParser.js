  ...
  try {
    ...
    if (stage < PARSER_STAGES.length) {
      ...
      if (position + needed > bytes.length) {
        ...
        stepInfo = {
          ...
          explanation:
            "The packet is shorter than expected for this parsing stage. This usually indicates a truncated or malformed packet.",
          values: {
        ...
        switch (stage) {
          case 0: {
            ...
            stepInfo = {
              ...
              explanation:
                "The header identifies the start of a Pioneer packet. Common headers are 0x2323 (##), 0x2727 ('' '') , or 0x2626 (& &).",
              values: { Header: `0x${header.toString(16).toUpperCase()}` },
              visualAids: [
                {
                  label: "Header Bytes",
                  content: `${headerByte1.toString(16).toUpperCase()} ${headerByte2.toString(16).toUpperCase()}`,
                },
              ],
            };
            break;
          ...
          case 1: {
            ...
            const typeName =
              Object.keys(PACKET_TYPES).find(
                (key) => PACKET_TYPES[key] === type,
              ) || `UNKNOWN_0x${type.toString(16)}`;
            ...
            stepInfo = {
              ...
              explanation:
                "The packet type determines how the rest of the packet should be parsed. Different types have different structures and data fields.",
              values: {
                "Packet Type": `0x${type.toString(16).toUpperCase()} (${typeName})`,
              },
              visualAids: [
                {
                  label: "Type Byte",
                  content: `0x${type.toString(16).toUpperCase()}`,
                },
              ],
            };
            break;
          ...
          case 2: {
            ...
            stepInfo = {
              ...
              explanation:
                "The length field indicates the total packet size. This helps the parser validate packet integrity and know where the packet ends.",
              values: { Length: `${length} bytes` },
              visualAids: [
                {
                  label: "Length Bytes",
                  content: `${lengthByte1.toString(16).toUpperCase()} ${lengthByte2.toString(16).toUpperCase()}`,
                },
              ],
            };
            break;
          ...
          case 3: {
            ...
            stepInfo = {
              ...
              explanation:
                "The index is a sequence number that helps detect missing or duplicate packets. It increments with each new packet sent by the device.",
              values: { Index: `${index}` },
              visualAids: [
                {
                  label: "Index Bytes",
                  content: `${indexByte1.toString(16).toUpperCase()} ${indexByte2.toString(16).toUpperCase()}`,
                },
              ],
            };
            break;
          ...
          case 4: {
            ...
            stepInfo = {
              ...
              explanation:
                "The IMEI is a unique 15-digit device identifier stored in BCD (Binary Coded Decimal) format where each digit occupies 4 bits (a nibble). 8 bytes become 15 digits.",
              values: { IMEI: imei, "Raw BCD Bytes": hexDump(imeiBytes) },
              visualAids: [
                { label: "IMEI Digits", content: imei.split("").join(" ") },
              ],
              commonPitfalls: [
          ...
          case 5: {
            ...
            const distanceComp = readInteger(
            ...
            stepInfo = {
              ...
              explanation:
                "These fields configure how the device reports acceleration events and compensates for speedometer inaccuracies.",
              values: {
          ...
          case 6: {
            ...
            stepInfo = {
              ...
              explanation:
                "The status byte contains critical information about GPS fix quality, live vs history classification, and satellite count.",
              values: {
          ...
          case 7: {
            ...
            stepInfo = {
              ...
              explanation:
                "GPS coordinates are stored as IEEE 754 32-bit floats in little-endian byte order. Each coordinate uses 4 bytes.",
              values: {
              ...
              visualAids: [
                {
                  ...
                  content:
                    "Each float uses 4 bytes, providing ~7 decimal digits of precision",
                },
              ],
              commonPitfalls: [
          ...
          case 8: {
            ...
            stepInfo = {
              ...
              explanation:
                "Speed is stored as a 32-bit integer representing 0.1 knot units. Conversion to km/h or mph is needed for human readability.",
              values: {
          ...
          case 9: {
            ...
            stepInfo = {
              ...
              explanation:
                "The timestamp stores year (offset from 2000), month, day, hour, minute, second as individual bytes — more compact than Unix timestamps.",
              values: {
                Year: `${year}`,
                Month: `${month}`,
                Day: `${day}`,
              ...
              visualAids: [
                {
                  ...
                  content:
                    `${(year - 2000).toString(16)} ${month.toString(16)} ${day.toString(16)} ${hour.toString(16)} ${minute.toString(16)} ${second.toString(16)}`.toUpperCase(),
                },
              ],
            };
            break;
      ...
      stepInfo = {
        ...
        explanation:
          "When no specific parser logic matches, remaining bytes are consumed as raw payload data.",
        values: {
          "Remaining Bytes": `${remainingBytes.length}`,
          "Raw Data (Hex)": hexDump(remainingBytes),
        },
      };
    }
    ...
    return {
      ...
      stepInfo: {
        ...
        explanation:
          "An error occurred during parsing. This could indicate corrupted data or an unexpected packet format.",
        values: {
          Error: error.message,
