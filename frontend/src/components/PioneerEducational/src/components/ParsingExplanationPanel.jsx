...
const ParsingExplanationPanel = ({ currentStep }) => {
  ...
  const hasRichExplanations =
    currentStep.explanations && currentStep.explanations.length > 0;
  ...
  return (
    <Paper elevation={3}>
      <Box p={3}>
        ...
        {/* Rich Explanations */}
        {hasRichExplanations &&
          currentStep.explanations.map((exp, index) => (
        ...
        {/* Common Pitfalls */}
        {currentStep.commonPitfalls &&
          currentStep.commonPitfalls.length > 0 && (
            <Box
              mt={4}
              p={2}
              sx={{
