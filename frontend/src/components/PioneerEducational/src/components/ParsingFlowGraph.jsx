...
const FLOWS = {
  [0x02]: [
    {
      ...
      description: "Identify 0x2323 header",
    },
    {
      id: "length",
      label: "Length Reading",
      description: "Read packet length field",
    },
    {
      id: "index",
      label: "Index Extraction",
      description: "Get packet sequence number",
    },
    {
      id: "imei",
      label: "IMEI Decoding",
      description: "Extract BCD-encoded IMEI",
    },
    {
      id: "config",
      label: "Configuration",
      description: "Read ACC/speed compensation",
    },
    {
      id: "gps_signal",
      label: "Signal Check",
      description: "Verify GPS signal status",
    },
    {
      id: "status",
      label: "Status Parsing",
      description: "Decode satellite count/flags",
    },
    {
      id: "sensors",
      label: "Sensor Data",
      description: "Read GSensor, IO, etc.",
    },
    {
      id: "position",
      label: "Position Data",
    ...
    },
    {
      ...
      description: "Parse date and timestamp",
    },
    {
      id: "speed",
      label: "Speed Calculation",
      description: "Convert raw speed value",
    },
    {
      id: "additional",
      label: "Additional Fields",
      description: "Process altitude, battery",
    },
    {
      id: "packet_build",
      label: "Packet Assembly",
      description: "Build TrackingPacket object",
    },
    {
      id: "kafka",
      label: "Kafka Serialization",
      description: "Convert to JSON and send",
    },
    {
      id: "ack",
      label: "ACK Generation",
      description: "Create and send response",
    },
  ],
  [0x04]: [
    {
    ...
    },
    {
      id: "length",
      label: "Length Reading",
      description: "Read packet length",
    },
    {
      id: "index",
      label: "Index Extraction",
    ...
    },
    {
      ...
      description: "Handle alarm/event data",
    },
    {
      id: "ack",
      label: "ACK Generation",
  ...
  [0x12]: [
    ...
    },
    {
      id: "timestamp",
      label: "Time Processing",
      description: "Parse BLE timestamp",
    },
    {
      id: "acc_status",
      label: "ACC Check",
      description: "Read accessory status",
    },
    { id: "gnss", label: "GNSS Data", description: "Process GPS information" },
    {
      id: "ble_data",
      label: "BLE Payload",
      description: "Handle BLE sensor data",
    },
    {
      id: "packet_build",
      label: "Packet Assembly",
      description: "Build TrackingPacket",
    },
    {
      id: "kafka",
      label: "Kafka Serialization",
  ...
  [0x44]: [
    ...
    },
    {
      id: "timestamp",
      label: "Time Processing",
      description: "Parse CAN timestamp",
    },
    {
      id: "can_data",
      label: "CAN Parsing",
      description: "Process CAN bus data",
    },
    {
      id: "packet_build",
      label: "Packet Assembly",
            ...
            <Box key={step.id} sx={{ position: "relative", px: 3, py: 2 }}>
              ...
              <Box
                sx={{
                  ...
                  width: 4,
                  height:
                    index === 0 ? 30 : index === flow.length - 1 ? 30 : 60,
                  marginLeft: -2,
                  bgcolor:
                    index <= currentStepIndex
                      ? theme.palette.success.main
              ...
              <Box
                sx={{
                  ...
                  top:
                    index * 60 +
                    (index === 0 ? 30 : index === flow.length - 1 ? -30 : 0),
                  width: 24,
                  height: 24,
                  marginLeft: -12,
                  backgroundColor:
              ...
              <Box
                sx={{
                  ...
                  top:
                    index * 60 +
                    (index === 0 ? 60 : index === flow.length - 1 ? -60 : 30),
                  width: 240,
                  marginLeft: -120,
                  textAlign: "center",
                  fontSize: 12,
            ...
            <Box
              sx={{
                ...
                top:
                  ...
                  (currentStepIndex === 0
                    ? 30
                    : currentStepIndex === flow.length - 1
                      ? -30
                      : 0),
                width: 32,
                height: 32,
