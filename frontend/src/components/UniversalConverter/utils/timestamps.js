...
export function getRelativeTime(d) {
  ...
  if (years > 0) return `${prefix}${years} year${years > 1 ? 's' : ''}${diff >= 0 ? ' ago' : ''}`;
  if (months > 0) return `${prefix}${months} month${months > 1 ? 's' : ''}${diff >= 0 ? ' ago' : ''}`;
  if (days > 0) return `${prefix}${days} day${days > 1 ? 's' : ''}${diff >= 0 ? ' ago' : ''}`;
  if (hours > 0) return `${prefix}${hours} hour${hours > 1 ? 's' : ''}${diff >= 0 ? ' ago' : ''}`;
  if (minutes > 0) return `${prefix}${minutes} minute${minutes > 1 ? 's' : ''}${diff >= 0 ? ' ago' : ''}`;
